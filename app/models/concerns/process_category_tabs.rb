...
module ProcessCategoryTabs
  ...
  private
    ...
    HEADERS = {
      ...
      'Category L1'             => /^\w*Category \(L1\)\w*$/i,
      'Category L1 Description' => /^\w*Category \(L1\) Description\w*$/i,
      'Category L2'             => /^\w*Category \(L2\)\w*$/i,
      'Category L2 Description' => /^\w*Category \(L2\) Description\w*$/i,
      'Category L3'             => /^\w*Category \(L3\)\w*$/i,
      'Category L3 Description' => /^\w*Category \(L3\) Description\w*$/i,
