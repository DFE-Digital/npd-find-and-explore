...
# WARDEN HOOKS FOR SINGLE SESSION
...
Warden::Manager.after_set_user only: :fetch do |record, warden, options|
  ...
  if record.respond_to?(:unique_session_id) && warden.authenticated?(scope)
...
Devise.setup do |config|
  ...
  # config.secret_key = '0e2c7aa28fb4817cbc1e434a0277c7fc9ac2d435e80456aedd547efac94895bae4fbacd6dcf7c195697cc77c02e3ef4e2cffe75b9448189c56adfd3e9326f7ba'
  ...
  config.mailer_sender = Rails.application.credentials.dig(Rails.env.to_sym, :office365, :user_name)
  ...
  # config.pepper = 'db4e123fd12f9c8ebd1b2e9d8e1f7931aed988a3f6032ddc5a0fa434d92885b0e23ab9927f41a6c3fbe74f830defa3da88615f4c0839a7f6886f819176af8946'
